...
class Nexus {
    ...
    getUserInfo() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [oAuthUserInfo, preferences] = yield Promise.all([oAuthUserInfoPromise, preferencePromise]);
            return Object.assign(Object.assign({}, oAuthUserInfo), { preferences });
        });
    }
    getTrackedMods() {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    getPreferences(query, useCache = true) {
        return __awaiter(this, void 0, void 0, function* () {
            if (useCache && this.mCachedPreferences !== undefined) {
                return this.mCachedPreferences;
            }
            yield this.mQuota.wait();
            const res = yield this.requestGraph('preferences', {}, query, {}, this.args({ path: this.filter({}) }));
    ...
    modsByUid(query, uids) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const chunk of chunkify(uids, param.MAX_BATCH_SIZE)) {
                ...
                }, { nodes: query }, { uids: chunk }, this.args({ path: this.filter({}) }))).nodes);
            }
            return res;
        });
    }
    ...
    modRequirements(query, modId, gameId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.mQuota.wait();
            const parameters = {
            ...
            const res = yield this.requestGraph('modRequirements', parameters, query, variables, this.args({ path: this.filter({}) }));
            return res;
        });
    }
    ...
    searchCollectionsGraph(query, options) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.mQuota.wait();
            const { gameId, count = 20, offset = 0, sort = { field: 'endorsements', direction: 'DESC' }, search, categoryName, collectionStatuses = ['listed', 'published', 'under_moderation', 'unlisted'], userId, adultContent, } = options;
            const sortParam = {};
